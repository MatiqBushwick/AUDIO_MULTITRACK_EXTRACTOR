...
1. Download the script file [chunk_extract.sh](https://downgit.github.io/#/home?url=https://github.com/MatiqBushwick/AUDIO_MULTITRACK_EXTRACTOR/blob/main/chunk_extract.sh)
